...
function guardarDireccion(codigos) {
  movimientos.push(codigos)
  actualizarUltimoMovimiento(codigos);
}
...
function mostrarCartelGanador() {
  if (chequearSiGano() == true) alertCustom();
}
...
function alertCustom() {
  ...
  document.getElementById('dialogboxheader').innerHTML = "Enhorabuena, lo has conseguido!";
  document.getElementById('dialogboxbody').innerHTML = "GANASTE!";
  document.getElementById('dialogboxfooter').innerHTML = '<button id="btn" onclick="Alerta">Jugar de nuevo</button>';
  var boton = document.getElementById("btn");
  boton.addEventListener("click", juegoNuevo, false);
}
